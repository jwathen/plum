...
namespace WaitlistApp.Tests.TestHelpers.Mvc
{
    ...
    where TController : AppControllerBase
             ...
             where TController : AppControllerBase
        {
            ...
            {
                throw new InvalidOperationException("Html.AntiForgeryToken can't be used in integration tests.  Use Html.AntiForgeryToken2 instead. (in WaitlistApp.Web.HtmlHelperExtensions)");
            }
