...
namespace WaitlistApp.Controllers
{
    public partial class AdminController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string ViewLog = "~/Views/Admin/ViewLog.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminController : WaitlistApp.Controllers.AdminController
    {
        ...
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ViewLog, "https");
