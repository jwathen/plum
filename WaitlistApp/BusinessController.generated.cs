...
namespace WaitlistApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BusinessController : WaitlistApp.Controllers.BusinessController
    {
        ...
        [NonAction]
        partial void UpdateBusinessInformationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WaitlistApp.ViewModels.Business.BusinessInformationViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> UpdateBusinessInformation(WaitlistApp.ViewModels.Business.BusinessInformationViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateBusinessInformation, "https");
        ...
        [NonAction]
        partial void UpdateSignInInformationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WaitlistApp.ViewModels.Business.SignInInformationViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> UpdateSignInInformation(WaitlistApp.ViewModels.Business.SignInInformationViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateSignInInformation, "https");
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void UpdateTextMessagesOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WaitlistApp.ViewModels.Business.TextMessagesViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> UpdateTextMessages(WaitlistApp.ViewModels.Business.TextMessagesViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateTextMessages, "https");
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
