...
namespace WaitlistApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : WaitlistApp.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void ContactUsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WaitlistApp.ViewModels.Home.ContactUsViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult ContactUs(WaitlistApp.ViewModels.Home.ContactUsViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ContactUs, "https");
