...
{
    public static WaitlistApp.Controllers.AccountController Account = new WaitlistApp.Controllers.T4MVC_AccountController();
    public static WaitlistApp.Controllers.AdminController Admin = new WaitlistApp.Controllers.T4MVC_AdminController();
    public static WaitlistApp.Controllers.BrandController Brand = new WaitlistApp.Controllers.T4MVC_BrandController();
    public static WaitlistApp.Controllers.BusinessController Business = new WaitlistApp.Controllers.T4MVC_BusinessController();
    public static WaitlistApp.Controllers.CustomerController Customer = new WaitlistApp.Controllers.T4MVC_CustomerController();
    public static WaitlistApp.Controllers.HomeController Home = new WaitlistApp.Controllers.T4MVC_HomeController();
    public static WaitlistApp.Controllers.PlivoController Plivo = new WaitlistApp.Controllers.T4MVC_PlivoController();
    public static WaitlistApp.Controllers.QueueController Queue = new WaitlistApp.Controllers.T4MVC_QueueController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static readonly string line_jpg = Url("line.jpg");
        ...
        public static class Scripts {
            ...
            public static class Account {
                public const string UrlPath = "~/Content/Scripts/Account";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            public static class CdnFallbacks {
                public const string UrlPath = "~/Content/Scripts/CdnFallbacks";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            public static class Home {
                public const string UrlPath = "~/Content/Scripts/Home";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            public static class Queue {
                public const string UrlPath = "~/Content/Scripts/Queue";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
        ...
        public static class Styles {
            ...
            public static class bootstrapsource {
                public const string UrlPath = "~/Content/Styles/bootstrapsource";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                ...
                public static class bootstrap {
                    public const string UrlPath = "~/Content/Styles/bootstrapsource/bootstrap";
                    public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                    public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                    ...
                    public static class mixins {
                        public const string UrlPath = "~/Content/Styles/bootstrapsource/bootstrap/mixins";
                        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                        public static readonly string _alerts_scss = Url("_alerts.scss");
            ...
            public static class Business {
                public const string UrlPath = "~/Content/Styles/Business";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class Home {
                public const string UrlPath = "~/Content/Styles/Home";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class Queue {
                public const string UrlPath = "~/Content/Styles/Queue";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                public static readonly string Show_scss = Url("Show.scss");
            }
