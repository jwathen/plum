...
namespace ASP
{
    ...
    public partial class _Views_Account_SignUp_cshtml : WaitlistApp.Web.ApplicationViewBase<WaitlistApp.ViewModels.Account.SignUpViewModel>
    {
...
WriteAttribute("action", Tuple.Create(" action=\"", 273), Tuple.Create("\"", 315)
            
            #line 11 "..\..\Views\Account\SignUp.cshtml"
, Tuple.Create(Tuple.Create("", 282), Tuple.Create<System.Object, System.Int32>(Url.Action(MVC.Account.SignUp())
