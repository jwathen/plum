...
namespace ASP
{
    ...
    public partial class _Views_Shared_DisplayTemplates_CustomerViewModel_cshtml_ : WaitlistApp.Web.ApplicationViewBase<WaitlistApp.ViewModels.Customer.CustomerViewModel>
    {
...
WriteAttribute("action", Tuple.Create(" action=\"", 2161), Tuple.Create("\"", 2213)
            
            #line 50 "..\..\Views\Shared\DisplayTemplates\CustomerViewModel.cshtml"
, Tuple.Create(Tuple.Create("", 2170), Tuple.Create<System.Object, System.Int32>(Url.Action(MVC.Customer.Destroy(Model.Id))
...
WriteAttribute("class", Tuple.Create(" class=\"", 3918), Tuple.Create("\"", 3942)
, Tuple.Create(Tuple.Create("", 3926), Tuple.Create("fa", 3926), true)
            
            #line 80 "..\..\Views\Shared\DisplayTemplates\CustomerViewModel.cshtml"
, Tuple.Create(Tuple.Create(" ", 3928), Tuple.Create<System.Object, System.Int32>(entry.Icon()
